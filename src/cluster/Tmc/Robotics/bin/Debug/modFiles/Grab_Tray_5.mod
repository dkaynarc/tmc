MODULE Module1
	...
	CONST jointtarget JointTarget_7:=[[-21.2,-62.6,48.2,108.3,-21.5,-65.2],[9E9,9E9,9E9,9E9,9E9,9E9]];
	CONST jointtarget JointTarget_8:=[[10.8,84.4,-35.9,107.7,-92.3,5.1],[9E9,9E9,9E9,9E9,9E9,9E9]];
