...
namespace APIServerWeb.EF
{
    ...
    public partial class ICTDEntities : DbContext
    {
        ...
        public virtual int FiltCompCyclLogBySour(Nullable<int> sourceID)
        {
            var sourceIDParameter = sourceID.HasValue ?
                new ObjectParameter("SourceID", sourceID) :
                new ObjectParameter("SourceID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FiltCompCyclLogBySour", sourceIDParameter);
        }
    
        public virtual int FiltCompEvenLogBySour(Nullable<int> sourceID)
        {
            var sourceIDParameter = sourceID.HasValue ?
                new ObjectParameter("SourceID", sourceID) :
                new ObjectParameter("SourceID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FiltCompEvenLogBySour", sourceIDParameter);
        }
    
        public virtual int FiltOrdeList(Nullable<int> statusID)
        {
            var statusIDParameter = statusID.HasValue ?
                new ObjectParameter("StatusID", statusID) :
                new ObjectParameter("StatusID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FiltOrdeList", statusIDParameter);
        }
