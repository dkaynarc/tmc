...
public class AlarmsAdapter extends ArrayAdapter<Alarm>
{
	...
	public AlarmsAdapter(Context context, int resource,
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (alarm != null)
		{
			TextView id = (TextView) v.findViewById(R.id.alarm_id_value);
			TextView type = (TextView) v.findViewById(R.id.alarm_type_value);
			TextView time = (TextView) v.findViewById(R.id.alarm_time_value);
